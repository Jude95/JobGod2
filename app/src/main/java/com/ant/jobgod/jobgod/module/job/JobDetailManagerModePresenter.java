 ...
 */
public class JobDetailManagerModePresenter extends BasePresenter<JobDetailManagerModeActivity> {
    private String id;
    private Job mJob;
    ...
    @Override
    protected void onCreateView(JobDetailManagerModeActivity view) {
